...
def create_question(question_text, days):
  """
  Create a questions with the given `question_text` and published the given number of `days`
  offset to now (negative for quations published in the past, positive for the questions that have yet to be published).
  """
